...
export function Hero() {
  return (
    <section
      id="hero"
      className="relative w-full overflow-hidden bg-slate-950 px-6 pt-40 pb-24 lg:px-12 lg:pt-48 lg:pb-32"
    >
      {/* Watermark image */}
      <div
        aria-hidden
      ...
      <div className="relative mx-auto w-full max-w-6xl">
        <motion.div 
          ...
          className="max-w-3xl"
        >
          <span className="mb-4 inline-block text-xs font-semibold uppercase tracking-[0.3em] text-white/75">
            Advocate &amp; Legal Consultant
          </span>

          <h1 className="mb-4 font-['Bookman_Old_Style',_serif] font-semibold text-4xl leading-[1.1] text-white sm:text-5xl md:text-6xl">
            Dialog, Litigasi <br />
            untuk Masyarakat.
          </h1>

          <p className="mb-3 font-['Bookman_Old_Style',_serif] text-xl italic text-white/80 sm:text-2xl">
